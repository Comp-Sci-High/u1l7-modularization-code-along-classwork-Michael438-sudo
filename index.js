...
let hero1 = heroAction("spider man", "webslinging", "queens")
console.log(hero1)

console.log(heroAction("magneto", "magnetic manipulation", "genosha"))
// 2. Classwork

// Task 1: Add more superheroes!
// Create at least two more superheroes by calling your function for each one.
console.log(heroAction("batman", "fighting styles", "gotham"))
console.log(heroAction("robin", "fighting styles", "gotham"))
...
console.log(villainAction("Doctor Octopus", "destroying cars with his mechanical arms", "Time Square"))
...
console.log(villainAction("Electro", "overloading the city's power grid", "Central Park"))
...
console.log(villainAction("Vulture", "swooping down and grabbing people off the streets", "Empire State Building"))
...
console.log(villainAction("Sandman", "turning the bridge into sand", "Brooklyn Bridge"))
...
console.log(villainAction("Mysterio", "casting illusions to confuse and panic everyone", "Broadway"))
...
// Setp 4: Add the function logic to return the full statement. 
 function villainAction (villain, chaos, location){
...
console.log(villainAction("Kraven The Hunter","he's releasing and hunting wild animals in the", "Bronx Zoo" ))
...
console.log(Action("T'Challa", "Wakanda", "Avengers", "Killmonger", "Wakanda Forever"))
...
console.log(Action("Iron Man", "NYC", "Avengers", "The Mandarin", "I am Iron Man"))